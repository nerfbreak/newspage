...
export async function createClient() {
  ...
  if (!url || !key) {
    console.error("CRITICAL ERROR: Supabase Environment Variables are missing! Please configure NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY in your Vercel project settings.");
  }
